    ...
    if sentence:
        ...
        try:
            ...
            for i, ent in enumerate(doc.ents):
                ...
                if len(doc.ents) == 7:
                    if i == 1 and ent.label_ == 'Column':
                        colObj["ColumnName"] = ent.text
                    if i == 2 and ent.label_ == 'Value':
                        colObj["ColumnValue"] = ent.text
                        colObj["Comparator"] = 'equal to' 
                    if i == 2 and ent.label_ == 'Comparator':
                        colObj["Comparator"] = ent.text   
                    if i == 3 and ent.label_ == 'Value':
                        colObj["ColumnValue"] = ent.text   
                    if i == 3 and ent.label_ == 'LogicalOperator':
                        colObj["LogicalOperator"] = ent.text  
                    if i == 4 and ent.label_ == 'Column':
                        colObj2["ColumnName"] = ent.text   
                    if i == 4 and ent.label_ == 'LogicalOperator':
                        colObj["LogicalOperator"] = ent.text  
                    if i == 5 and ent.label_ == 'Column':
                        colObj2["ColumnName"] = ent.text   
                        colObj2["Comparator"] = 'equal to'
                    if i == 5 and ent.label_ == 'Comparator':
                        colObj2["Comparator"] = ent.text      
                    if i == 6 and ent.label_ == 'Value':
                        colObj2["ColumnValue"] = ent.text   
